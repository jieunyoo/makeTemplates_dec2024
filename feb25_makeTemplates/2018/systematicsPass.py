...
# DYJets', 'EWKWjets', 'EWKZjets', 'ggF', 'ZH', 'WH', 'SingleTop', 'TTbar', 'VBF', 'WJetsLNu', 'WQQ', 'Diboson', 'ZQQ', 'ttH', 'Data'
...
def get_systematic_dict(years):
    ...
    for year in years:
        JEC_systs_mass1 = {
            **JEC_systs_mass1,
            **{
                f"pass_JMR_sig_{year}": (
                    year,
                    sigs,
                    {"ele": "JMR", "mu": "JMR"},
                ),
                 f"pass_JMS_sig_{year}": (
                    year,
                    sigs,
                    {"ele": "JMS", "mu": "JMS"},
                ),
    ...
    for year in years:
        JEC_systs_mass2 = {
            **JEC_systs_mass2,
            **{
                f"pass_JMR_ttbar_{year}": (
                    year,
                    ["TTbar", "Diboson", "SingleTop"],
                    {"ele": "JMR", "mu": "JMR"},
                ),
                 f"pass_JMS_ttbar_{year}": (
                    year,
                    ["TTbar", "Diboson", "SingleTop"],
                    {"ele": "JMS", "mu": "JMS"},
                ),
    ...
    for year in years:
        JEC_systs_mass3 = {
            **JEC_systs_mass3,
            **{
                f"pass_JMR_wjets_{year}": (
                    year,
                    ['WJetsLNu', 'DYJets'],
                    {"ele": "JMR", "mu": "JMR"},
                ),
                 f"pass_JMS_wjets_{year}": (
                    year,
                    ['WJetsLNu', 'DYJets'],
                    {"ele": "JMS", "mu": "JMS"},
                ),
    ...
    VtaggerUncertainty = {
       "pass_weight_Vtagger": (  years,  sigs + ["TTbar", "Diboson", "SingleTop" ],
     #   "pass_weight_Vtagger": (  years,  sigs + ["TTbar", "Dibson", "SingleTop", "EWKvjets"],
            {"ele": "Vtagger", "mu": "Vtagger"},
        ),
   }

    VtaggerUncertainty_mistag = {
       "pass_weight_Vtagger_mistag": (  years,  sigs + ["TTbar", "Diboson", "SingleTop", "EWKvjets"],
            {"ele": "Vtagger_mistag", "mu": "Vtagger_mistag"},
        ),
   }
    ...
    SYST_DICT = {
        "JEC_systs_mass1": {**JEC_systs_mass1},
        "JEC_systs_mass2": {**JEC_systs_mass2},
         "JEC_systs_mass3": {**JEC_systs_mass3},
        
        
         "Vtag": {**VtaggerUncertainty},
        "Vtag2": {**VtaggerUncertainty_mistag},
