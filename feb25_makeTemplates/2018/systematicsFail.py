...
def get_systematic_dict(years):
    ...
    for year in years:
        JEC_systs_mass1 = {
            **JEC_systs_mass1,
            **{
                f"fail_JMR_sig_{year}": (
                    year,
                    sigs,
                    {"ele": "JMR", "mu": "JMR"},
                ),
                 f"fail_JMS_sig_{year}": (
                    year,
                    sigs,
                    {"ele": "JMS", "mu": "JMS"},
                ),
    ...
    for year in years:
        JEC_systs_mass2 = {
            **JEC_systs_mass2,
            **{
                f"fail_JMR_ttbar_{year}": (
                    year,
                    ["TTbar", "Diboson", "SingleTop"],
                    {"ele": "JMR", "mu": "JMR"},
                ),
                 f"fail_JMS_ttbar_{year}": (
                    year,
                    ["TTbar", "Diboson", "SingleTop"],
                    {"ele": "JMS", "mu": "JMS"},
                ),
    ...
    for year in years:
        JEC_systs_mass3 = {
            **JEC_systs_mass3,
            **{
                f"fail_JMR_wjets_{year}": (
                    year,
                    ['WJetsLNu', 'DYJets'],
                    {"ele": "JMR", "mu": "JMR"},
                ),
                 f"fail_JMS_wjets_{year}": (
                    year,
                    ['WJetsLNu', 'DYJets'],
                    {"ele": "JMS", "mu": "JMS"},
                ),
    ...
    VtaggerUncertainty = {
       "fail_weight_Vtagger": (  years,  sigs + ["TTbar", "Dibson", "SingleTop"],
            {"ele": "Vtagger", "mu": "Vtagger"},
        ),
   }

    VtaggerUncertainty_mistag = {
       "fail_weight_Vtagger_mistag": (  years,  sigs + ["TTbar", "Dibson", "SingleTop", "EWKvjets"],
