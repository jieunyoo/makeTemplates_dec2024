...
def dummy_rhalphabet( scale_syst=True, smear_syst=True,  systs=True,muonCR=False,year='2018',  opts=None):
    ...
    sys_shape_dict['fakes_SF'] = rl.NuisanceParameter('CMS_HWW_FakeRate_EWK_SF_uncertainty', 'shape')
               ...
               "weight_d1K_NLO", "weight_d2K_NLO", "weight_d3K_NLO",
                ...
                for sys_name in sys_names_toLnN:
                    ...
                    if sys_shape_dict[sys_name].combinePrior == "lnN":
                        ...
                        #print('syst_down', syst_down)
                        eff_up = shape_to_num2(syst_up,nominal)
                        eff_down = shape_to_num2(syst_down,nominal)
                      
                        #print('systematic', sys_name, sName)
                        #print('eff_up', eff_up)
                        #print('eff_down', eff_down)
...
#def get_templ(f, region, sample, syst=None, muon=False, n
        ...
        if sNameFake == 'fake': 
            ...
            for sys_nameFake in fakes_sys_names:   
                #print('sys_nameFake', sys_nameFake)
...
#******************************************************
ROOTFILE = '/home/jieun/VH-makeCards2/2018/2018.root'
import os
thisdir = os.getcwd()
