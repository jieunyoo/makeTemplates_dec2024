...
for i, reg in enumerate(regions):
    ...
    print('tgo[0]', tgo[0])
    print('unumpy.nominal_values(ratio)',unumpy.nominal_values(ratio))
    print('unumpy.nominal_values(ratio)[0]', unumpy.nominal_values(ratio)[0])
    print(' unumpy.std_devs(ratio),',  unumpy.std_devs(ratio))
    print(' unumpy.std_devs(ratio)[0],',  unumpy.std_devs(ratio[0]))
    #rax.errorbar(tgo[0], unumpy.nominal_values(ratio)[0], unumpy.std_devs(ratio), xerr=tgo[3], fmt='o', color='black', label='Data')

    rax.errorbar(tgo[0], unumpy.nominal_values(ratio)[0], unumpy.std_devs(ratio[0]), xerr=tgo[3], fmt='o', color='black', label='Data')
