...
def test_sfmodel(fittype='single', scale=0.1, smear=0.2, template_dir={}, fit_dir=None):
    ...
    #msdbins = np.linspace(60, 120, 20)
    #msdbins = np.linspace(40, 141.5, 20)

    msdbins = np.linspace(40, 180, 40)
    ...
    for template, region in regions:
        ...
        wqq_sample.setParamEffect(lumi, 1.015)  #2018: 1.015,  2017: 1.02, 2016:1.01
...
if __name__ == '__main__':
    ...
    for region, path in zip(regions, [args.template1]):
        try:
