...
#*********************************************************************************
  ...
  #  sys_shape_dict['weight_pdf_acceptance_SingleTop'] = rl.NuisanceParameter('PDF_singletop_ACCEPT_CMS_HWW_boosted', 'shape')
    ...
    #sys_shape_dict['weight_qcd_scale_TTbar'] = rl.NuisanceParameter('QCDscale_ttbar_ACCEPT_CMS_HWW_boosted', 'sh')
...
#******************************************************
ROOTFILE = '/home/jieun/VH-makeCards2/feb4_2016APV/2016APV_fail.root'
import os
thisdir = os.getcwd()
