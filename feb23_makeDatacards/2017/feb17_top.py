...
#*********************************************************************************
    ...
    sys_shape_dict['JMR_wjets_2017'] = rl.NuisanceParameter('CMS_HWW_boosted_jmr_wjets_{}'.format(year), 'lnN') 
    sys_shape_dict['JMS_wjets_2017'] = rl.NuisanceParameter('CMS_HWW_boosted_jms_wjets_{}'.format(year), 'lnN') 

    sys_shape_dict['JMR_ttbar_2017'] = rl.NuisanceParameter('CMS_HWW_boosted_jmr_ttbar_{}'.format(year), 'lnN') 
    sys_shape_dict['JMS_ttbar_2017'] = rl.NuisanceParameter('CMS_HWW_boosted_jms_ttbar_{}'.format(year), 'lnN') 
            ...
            if not systs:  # Need at least one
               ...
               # 'weight_pdf_acceptance_SingleTop',
                ...
                for sys_name in sys_names_toLnN:
                    ...
                    if ("JMR_ttbar_2017" in sys_name) and sName not in ['TTbar', 'SingleTop', 'Diboson']:
                        continue
                    if ("JMS_ttbar_2017" in sys_name) and sName not in ['TTbar', 'SingleTop', 'Diboson']:
                        continue    
...
#******************************************************
#ROOTFILE = '/home/jieun/VH-makeCards2/feb4_2017/2017_TopCR.root'
ROOTFILE = '/home/jieun/VH-makeCards2/feb4_2017/2017_TopCR_parT.root'
