...
#*********************************************************************************
   ...
   # sys_shape_dict['weight_qcd_scale_WJetsLNu'] = rl.NuisanceParameter('QCDscale_wjets_ACCEPT_CMS_HWW_boosted', 'shape')
    ...
    #SHAPE*****************************************
    sys_shape_dict['JMR_sig_2018'] = rl.NuisanceParameter('CMS_HWW_boosted_jmr_sig_{}'.format(year), 'shape') 
    sys_shape_dict['JMS_sig_2018'] = rl.NuisanceParameter('CMS_HWW_boosted_jms_sig_{}'.format(year), 'shape') 

    sys_shape_dict['JMR_wjets_2018'] = rl.NuisanceParameter('CMS_HWW_boosted_jmr_wjets_{}'.format(year), 'shape') 
    sys_shape_dict['JMS_wjets_2018'] = rl.NuisanceParameter('CMS_HWW_boosted_jms_wjets_{}'.format(year), 'shape') 

    sys_shape_dict['JMR_ttbar_2018'] = rl.NuisanceParameter('CMS_HWW_boosted_jmr_ttbar_{}'.format(year), 'shape') 
    sys_shape_dict['JMS_ttbar_2018'] = rl.NuisanceParameter('CMS_HWW_boosted_jms_ttbar_{}'.format(year), 'shape') 
            ...
            'weight_qcd_scale_WH', 
              ...
              # 'weight_qcd_scale_WJetsLNu',
                ...
                for sys_name in sys_names:   
                    ...
                    if ("JMR_sig_2018" in sys_name) and sName not in ['WH', 'ZH', 'ggF', 'VBF', 'ttH']:      
                        continue
                    if ("JMS_sig_2018" in sys_name) and sName not in ['WH', 'ZH', 'ggF', 'VBF', 'ttH']:          
                        continue    
      
                    if ("JMR_wjets_2018" in sys_name) and sName not in ['WJetsLNu', 'DYJets']:
                        continue
                    if ("JMS_wjets_2018" in sys_name) and sName not in ['WJetsLNu', 'DYJets']:
                        continue    


                    if ("JMR_ttbar_2018" in sys_name) and sName not in ['TTbar', 'SingleTop', 'Diboson', 'EWKvjets']:
                        continue
                    if ("JMS_ttbar_2018" in sys_name) and sName not in ['TTbar', 'SingleTop', 'Diboson', 'EWKvjets']:
                        continue    
...
#******************************************************
ROOTFILE = '/home/jieun/VH-makeCards2/feb4_2018/2018_pass.root'
import os
thisdir = os.getcwd()
