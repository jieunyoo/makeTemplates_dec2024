...
#*********************************************************************************
    ...
    #SHAPE*****************************************
    sys_shape_dict['JMR_wjets_2018'] = rl.NuisanceParameter('CMS_HWW_boosted_jmr_wjets_{}'.format(year), 'lnN') 
    sys_shape_dict['JMS_wjets_2018'] = rl.NuisanceParameter('CMS_HWW_boosted_jms_wjets_{}'.format(year), 'lnN') 

    sys_shape_dict['JMR_ttbar_2018'] = rl.NuisanceParameter('CMS_HWW_boosted_jmr_ttbar_{}'.format(year), 'lnN') 
    sys_shape_dict['JMS_ttbar_2018'] = rl.NuisanceParameter('CMS_HWW_boosted_jms_ttbar_{}'.format(year), 'lnN') 
             ...
             #  'weight_L1Prefiring',
               ...
               # 'weight_pdf_acceptance_SingleTop',
                ...
                for sys_name in sys_names_toLnN:
                    ...
                    if ("JMR_ttbar_2018" in sys_name) and sName not in ['TTbar', 'SingleTop', 'Diboson']:
                        continue
                    if ("JMS_ttbar_2018" in sys_name) and sName not in ['TTbar', 'SingleTop', 'Diboson']:
                        continue    
...
#******************************************************
#ROOTFILE = '/home/jieun/VH-makeCards2/feb4_2018/2018_TopCR.root'
ROOTFILE = '/home/jieun/VH-makeCards2/feb4_2018/2018_TopCR_feb19_parT.root'
