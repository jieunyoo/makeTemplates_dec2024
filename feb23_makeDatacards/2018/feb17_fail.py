...
#*********************************************************************************
  ...
  #  sys_shape_dict['weight_pdf_acceptance_SingleTop'] = rl.NuisanceParameter('PDF_singletop_ACCEPT_CMS_HWW_boosted', 'shape')
   ...
   # sys_shape_dict['weight_qcd_scale_WJetsLNu'] = rl.NuisanceParameter('QCDscale_wjets_ACCEPT_CMS_HWW_boosted', 'shape')
    ...
    #SHAPE*****************************************
    sys_shape_dict['JMR_wjets_2018'] = rl.NuisanceParameter('CMS_HWW_boosted_jmr_wjets_{}'.format(year), 'shape') #this is "scale"
    sys_shape_dict['JMS_wjets_2018'] = rl.NuisanceParameter('CMS_HWW_boosted_jms_wjets_{}'.format(year), 'shape') #this is "scale"

    sys_shape_dict['JMR_ttbar_2018'] = rl.NuisanceParameter('CMS_HWW_boosted_jmr_ttbar_{}'.format(year), 'shape') #this is "scale"
    sys_shape_dict['JMS_ttbar_2018'] = rl.NuisanceParameter('CMS_HWW_boosted_jms_ttbar_{}'.format(year), 'shape') #this is "scale"
...
#******************************************************
ROOTFILE = '/home/jieun/VH-makeCards2/feb4_2018/2018_fail.root'
import os
thisdir = os.getcwd()
