...
#*********************************************************************************
  ...
  #  sys_shape_dict['weight_pdf_acceptance_SingleTop'] = rl.NuisanceParameter('PDF_singletop_ACCEPT_CMS_HWW_boosted', 'shape')
    ...
    model = rl.Model("shapes_WJetLNu" + year)  # build actual fit model now
    ...
    #******************
            ...
            if not systs:  # Need at least one
                ...
                'top_reweighting',
               # 'weight_Vtagger',  #no vtagger applied in fail region
...
#******************************************************
ROOTFILE = '/home/jieun/VH-makeCards2/feb4_2016/2016_fail.root'
import os
thisdir = os.getcwd()
