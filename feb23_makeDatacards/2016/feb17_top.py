...
#*********************************************************************************
   ...
   # sys_shape_dict['weight_qcd_scale_WJetsLNu'] = rl.NuisanceParameter('QCDscale_wjets_ACCEPT_CMS_HWW_boosted', 'lnN')
    ...
    #SHAPE*****************************************
    sys_shape_dict['JMR_wjets_2016'] = rl.NuisanceParameter('CMS_HWW_boosted_jmr_wjets_{}'.format(year), 'lnN') 
    sys_shape_dict['JMS_wjets_2016'] = rl.NuisanceParameter('CMS_HWW_boosted_jms_wjets_{}'.format(year), 'lnN') 
    sys_shape_dict['JMR_ttbar_2016'] = rl.NuisanceParameter('CMS_HWW_boosted_jmr_ttbar_{}'.format(year), 'lnN') 
    sys_shape_dict['JMS_ttbar_2016'] = rl.NuisanceParameter('CMS_HWW_boosted_jms_ttbar_{}'.format(year), 'lnN') 
           ...
           # 'weight_qcd_scale_WJetsLNu',
              ...
              'JMR_wjets_2016', 
                  ...
                  #  if ("weight_qcd_scale_WJetsLNu" in sys_name) and sName not in ['WJetsLNu']:
                   #     continue
                    ...
                    if ("JMS_wjets_2016" in sys_name) and sName not in ['WJetsLNu', 'DYJets']:
                        continue    
                    if ("JMR_ttbar_2016" in sys_name) and sName not in ['TTbar', 'SingleTop', 'Diboson']:
                        continue
                    if ("JMS_ttbar_2016" in sys_name) and sName not in ['TTbar', 'SingleTop', 'Diboson']:
                        continue    
                ...
                for sys_name in btaggingList:
                    print('sample, syst', sample, sys_name)
                    if sys_shape_dict[sys_name].combinePrior == "lnN":
...
#******************************************************
#ROOTFILE = '/home/jieun/VH-makeCards2/feb4_2016/2016_TopCR.root'
ROOTFILE = '/home/jieun/VH-makeCards2/feb4_2016/2016_TopCR_feb19_parT.root'
