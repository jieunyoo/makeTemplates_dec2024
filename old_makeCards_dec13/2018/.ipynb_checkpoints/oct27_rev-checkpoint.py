...
def get_bins():
    #ptbins = np.array([40,70,105,135,180])
...
def dummy_rhalphabet( scale_syst=True, smear_syst=True,  systs=True,muonCR=False,year='2018',  opts=None):
    ...
    #sys_shape_dict["weight_L1Prefiring"] = rl.NuisanceParameter('CMS_l1_ecal_prefiring_{}'.format(year),'shape') #comment out only for 2018
    ...
    for region in ['pass', 'fail']:
        ...
        if region == 'pass':
             include_samples = [
                'WH', 'ZH', 'VBF', 'ggF', 'ttH',
                'WJetsLNu', 'TTbar', 'SingleTop','DYJets',  #'EWKvjets', 
            'Diboson', 
           'WZQQ',
            ]
        elif region == 'fail':
...
#******************************************************
ROOTFILE = '/home/jieun/VH-makeCards/2018/2018.root'
import os
thisdir = os.getcwd()
